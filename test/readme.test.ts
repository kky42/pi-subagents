...
describe("README", () => {
  ...
  it("states the asynchronous lifecycle immediately after the sanitized screenshot caption", () => {
    ...
    expect(readme).not.toMatch(/^## (?:Headless execution|Define your agent team|Use a focused subagent|Choose Agent or workflow by task shape|Built for real work)$/m);
  });
